...
Zaradi velike časovni zahtevnosti nekaterih izmed klicanih funkcij, kamor spada $independent\_set()$ ter $hamiltonian_path()$ sva doživela problem pri času izvajanja kode.
