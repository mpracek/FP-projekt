...
V našem primeru sva se odločila, da bomo začetno populacija določili s pomočjo funkcije $zacetne\_populacija(maksimalna)$,  kjer določimo začetno množico povezanih grafov. Z vrednostjo maksimalna smo določili največjo velikost generacije.\\
...
\begin{figure}[h]
	\includegraphics[scale=0.6]{slike/GA}
\end{figure}
\ \\
...
\begin{figure}[h]
	\includegraphics[scale=0.8]{grafi/konec}
\end{figure}
\ \\
